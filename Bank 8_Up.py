...
def process_pdf(file):
    ...
    for _, row in df.iterrows():
        ...
        dr_cols = ['WITHDRAWAL (DR.)', 'WITHDRAWAL (DR)', 'WITHDRAWAL AMT.', 'WITHDRAWAL', 'WITHDRAWALS', 'DEBITS', 'DEBIT']
        cr_cols = ['DEPOSIT (CR.)', 'DEPOSIT (CR)', 'DEPOSIT AMT.', 'DEPOSIT', 'DEPOSITS', 'CREDITS', 'CREDIT']
        ...
        desc_cols = ['PARTICULARS', 'DESCRIPTION', 'REMARKS', 'NARRATION', 'TRANSACTION DETAILS', 'REMARK', 'PAYMENT NARRATION']
        description = "N/A"
